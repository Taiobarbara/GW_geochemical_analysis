...
# MPs to project
mp_vars = ["PVC_ppl","PS_ppl","PET_ppl","MPs_ppl","PE_ppl","PP_ppl"]

# Key CECs to project
cec_vars = ["BPS", "DEET", "ensulizole", "caffeine", "valsartan", "BTA", "salicylic_acid"]
